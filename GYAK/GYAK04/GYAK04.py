...
# %%
'''
Készíts egy függvényt ami a bemeneti DataFrame-ből vissza adja csak azt az oszlopot amelynek
 a neve a bemeneti string-el megegyező.
...
# %%
'''
Készíts egy függvényt ami a bemeneti DataFrame-ből kiszámolja az országok
népsűrűségét és eltárolja az eredményt egy új oszlopba ('density').
...
def population_density(test_df):
    newDf = test_df.copy()
    dens = newDf['population']/newDf['area']
    newDf['density'] = dens
    return newDf
